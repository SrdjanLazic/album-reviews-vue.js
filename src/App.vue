<template>
  <div id="app">
    <div>
      <b-navbar class="navbar" toggleable="sm" type="dark" variant="dark">
        <b-navbar-brand to="/" class="name"><b-icon-music-note-beamed></b-icon-music-note-beamed>  MusicDB</b-navbar-brand>
